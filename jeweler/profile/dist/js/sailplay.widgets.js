...
window._LOCALE = {
  ...
  gift_received: 'ÐŸÐ¾Ð´Ð°Ñ€Ð¾Ðº Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½ Ð² ÐºÐ¾Ñ€Ð·Ð¸Ð½Ñƒ!',
  gift_error: 'Ðš ÑÐ¾Ð¶Ð°Ð»ÐµÐ½Ð¸ÑŽ, Ð²Ñ‹ Ð½Ðµ Ð¿Ð¾Ð»ÑƒÑ‡Ð¸Ð»Ð¸ Ð¿Ð¾Ð´Ð°Ñ€Ð¾Ðº!',
  gift_error_points: 'ÐÐµÐ´Ð¾ÑÑ‚Ð°Ñ‚Ð¾Ñ‡Ð½Ð¾ Ð±Ð°Ð»Ð»Ð¾Ð² Ð´Ð»Ñ Ð¿Ð¾Ð»ÑƒÑ‡ÐµÐ½Ð¸Ñ ÑÑ‚Ð¾Ð³Ð¾ Ð¿Ð¾Ð´Ð°Ñ€ÐºÐ°',
  error: 'ÐžÑˆÐ¸Ð±ÐºÐ°',
  perform: 'Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ',
  history_items: {
    "purchase": "ÐŸÐ¾ÐºÑƒÐ¿ÐºÐ°",
    "gift_purchase": "ÐŸÐ¾Ð´Ð°Ñ€Ð¾Ðº",
    "badge": "Ð‘ÐµÐ¹Ð´Ð¶Ð¸Ðº",
    "registration": "Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ñ",
    "referral": "Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ñ Ð´Ñ€ÑƒÐ³Ð°",
    "referred": "Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ñ Ð¿Ð¾ Ð¿Ñ€Ð¸Ð³Ð»Ð°ÑˆÐµÐ½Ð¸ÑŽ",
    "referred_purchase": "ÐŸÐ¾ÐºÑƒÐ¿ÐºÐ° Ð¿Ñ€Ð¸Ð³Ð»Ð°ÑˆÐµÐ½Ð½Ð¾Ð³Ð¾ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ",
    "promocode": "Ð—Ð° Ð²Ð²Ð¾Ð´ Ð¿Ñ€Ð¾Ð¼Ð¾ÐºÐ¾Ð´Ð°",
    "enter_group": "Ð’ÑÑ‚ÑƒÐ¿Ð»ÐµÐ½Ð¸Ðµ Ð² Ð³Ñ€ÑƒÐ¿Ð¿Ñƒ ",
    "share_purchase": "Ð Ð°ÑÑÐºÐ°Ð· Ð¾ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐµ Ð² ",
    "social_share": "Ð Ð°ÑÑÐºÐ°Ð· Ð² ",
    "share_badge": "Ð Ð°ÑÑÐºÐ°Ð· Ð¾ Ð±ÐµÐ¹Ð´Ð¶Ð¸ÐºÐµ Ð² ",
    "earn_badge": 'ÐŸÐ¾Ð»ÑƒÑ‡ÐµÐ½ Ð±ÐµÐ¹Ð´Ð¶Ð¸Ðº ',
    "custom_action": "Ð­ÐºÑÑ‚Ñ€Ð°"
  },
  errors: {
    'email is not valid': 'Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ñ‹Ð¹ E-Mail',
    '-200007': 'ÐŸÐ¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒ Ñ Ñ‚Ð°ÐºÐ¸Ð¼ Ð½Ð¾Ð¼ÐµÑ€Ð¾Ð¼ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½Ð° ÑƒÐ¶Ðµ Ð·Ð°Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ð½. Ð•ÑÐ»Ð¸ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚ Ñ ÑÑ‚Ð¸Ð¼ Ð½Ð¾Ð¼ÐµÑ€Ð¾Ð¼ Ð¿Ñ€Ð¸Ð½Ð°Ð´Ð»ÐµÐ¶Ð¸Ñ‚ Ð’Ð°Ð¼, Ð·Ð°Ð¹Ð´Ð¸Ñ‚Ðµ Ð² Ð»Ð¸Ñ‡Ð½Ñ‹Ð¹ ÐºÐ°Ð±Ð¸Ð½ÐµÑ‚, Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÑ Ð´Ð°Ð½Ð½Ñ‹Ðµ ÑÑ‚Ð¾Ð³Ð¾ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚Ð°',
    '-200010': 'ÐŸÐ¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒ Ñ Ñ‚Ð°ÐºÐ¸Ð¼ Ð°Ð´Ñ€ÐµÑÐ¾Ð¼ ÑÐ». Ð¿Ð¾Ñ‡Ñ‚Ñ‹ ÑƒÐ¶Ðµ Ð·Ð°Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ð½. Ð•ÑÐ»Ð¸ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚ Ñ ÑÑ‚Ð¸Ð¼ Ð°Ð´Ñ€ÐµÑÐ¾Ð¼ Ð¿Ñ€Ð¸Ð½Ð°Ð´Ð»ÐµÐ¶Ð¸Ñ‚ Ð’Ð°Ð¼, Ð·Ð°Ð¹Ð´Ð¸Ñ‚Ðµ Ð² Ð»Ð¸Ñ‡Ð½Ñ‹Ð¹ ÐºÐ°Ð±Ð¸Ð½ÐµÑ‚, Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÑ Ð´Ð°Ð½Ð½Ñ‹Ðµ ÑÑ‚Ð¾Ð³Ð¾ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚Ð°'
  },
  actions: {
    "system": {
      "emailBinding": {
        name: "ÐŸÑ€Ð¸Ð²ÑÐ¶Ð¸Ñ‚Ðµ E-Mail"
      },
      "fillProfile":{
        name: "Ð—Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚Ðµ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»ÑŒ"
      },
      "inviteFriend":{
        name: "ÐŸÑ€Ð¸Ð³Ð»Ð°ÑÐ¸Ñ‚Ðµ Ð´Ñ€ÑƒÐ³Ð°",
    ...
    "social": {
      "vk": {
        "like": {
          "name": "Ð’ÑÑ‚ÑƒÐ¿Ð¸Ñ‚Ðµ Ð² Ð³Ñ€ÑƒÐ¿Ð¿Ñƒ VK",
          pic: 'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/80bfe068b09d99a22ce81e46ae4d8243.svg'
        },
        "partner_page": {
          "name": "Ð Ð°ÑÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¾ Ð½Ð°ÑˆÐµÐ¼ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ðµ Ð² VK",
          pic: 'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/80bfe068b09d99a22ce81e46ae4d8243.svg'
        },
        "purchase": {
          "name": "ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÐµÑÑŒ Ð²Ð°ÑˆÐµÐ¹ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¾Ð¹ Ð² VK",
          pic: 'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/f8acb4763cb49eaaa454d5f928372413.svg'
        }
      },
      "fb": {
        "like": {
          "name": "Ð’ÑÑ‚ÑƒÐ¿Ð¸Ñ‚Ðµ Ð² Ð³Ñ€ÑƒÐ¿Ð¿Ñƒ Facebook",
          pic: 'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/3d203916db24a1ee62d20393c591652e.svg'
        },
        "partner_page": {
          "name": "Ð Ð°ÑÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¾ Ð½Ð°ÑˆÐµÐ¼ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ðµ Ð² Facebook",
          pic: 'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/3d203916db24a1ee62d20393c591652e.svg'
        },
        "purchase": {
          "name": "ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÐµÑÑŒ Ð²Ð°ÑˆÐµÐ¹ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¾Ð¹ Ð² Facebook",
          pic: 'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/f8acb4763cb49eaaa454d5f928372413.svg'
        }
      },
      "gp": {
        "like": {
          "name": "Ð’ÑÑ‚ÑƒÐ¿Ð¸Ñ‚Ðµ Ð² Ð³Ñ€ÑƒÐ¿Ð¿Ñƒ Google+"
        },
        "partner_page": {
          "name": "Ð Ð°ÑÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¾ Ð½Ð°ÑˆÐµÐ¼ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ðµ Ð² Google+"
        },
        "purchase": {
          "name": "ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÐµÑÑŒ Ð²Ð°ÑˆÐµÐ¹ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¾Ð¹ Ð² Google+"
        }
      },
      "ok": {
        "like": {
          "name": "Ð’ÑÑ‚ÑƒÐ¿Ð¸Ñ‚Ðµ Ð² Ð³Ñ€ÑƒÐ¿Ð¿Ñƒ ÐžÐ´Ð½Ð¾ÐºÐ»Ð°ÑÑÐ½Ð¸ÐºÐ¸"
        },
        "partner_page": {
          "name": "Ð Ð°ÑÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¾ Ð½Ð°ÑˆÐµÐ¼ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ðµ Ð² ÐžÐ´Ð½Ð¾ÐºÐ»Ð°ÑÑÐ½Ð¸ÐºÐ¸"
        },
        "purchase": {
          "name": "ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÐµÑÑŒ Ð²Ð°ÑˆÐµÐ¹ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¾Ð¹ Ð² ÐžÐ´Ð½Ð¾ÐºÐ»Ð°ÑÑÐ½Ð¸ÐºÐ¸"
        }
      },
      "tw": {
        "partner_page": {
          "name": "Ð Ð°ÑÑÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¾ Ð½Ð°ÑˆÐµÐ¼ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ðµ Ð² Twitter",
          pic: 'dist/img/actions/twitter.png'
        },
        "purchase": {
          "name": "ÐŸÐ¾Ð´ÐµÐ»Ð¸Ñ‚ÐµÑÑŒ Ð²Ð°ÑˆÐµÐ¹ Ð¿Ð¾ÐºÑƒÐ¿ÐºÐ¾Ð¹ Ð² Twitter",
          pic: 'dist/img/actions/twitter.png'
        }
      }
    }
...
(function(module) {
  ...
  module.run(['$templateCache', function($templateCache) {
    $templateCache.put('/html/app.html',
      '<div data-sailplay-profile="" data-sailplay-history="" data-sailplay-badges="" style="margin: 14px;" data-ng-show="user()" data-ng-cloak=""><div class="sp_widget"><section class="sp_l-centered sp_person-sec"><div class="sp_person-sec__col1"><div class="sp_person-sec__hd">Ð”Ð¾Ð±Ñ€Ð¾ Ð¿Ð¾Ð¶Ð°Ð»Ð¾Ð²Ð°Ñ‚ÑŒ</div><div class="sp_person-sec__ttl">Ð² ÐºÐ»ÑƒÐ± Ð¿Ð¾ÐºÑƒÐ¿Ð°Ñ‚ÐµÐ»ÐµÐ¹ "Ð‘Ñ€Ð¾Ð½Ð½Ð¸Ñ†ÐºÐ¸Ð¹ ÑŽÐ²ÐµÐ»Ð¸Ñ€"</div></div><div class="sp_person-sec__col2"><div class="sp_person-cell"><div class="sp_person-cell__photo" style="background-image: url(\'{{ user().user.pic | sailplay_pic }}\');"></div><a href="#" class="sp_cmn-btn person-cell__btn js-open-profile-popup" data-ng-click="open_profile()">Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»ÑŒ</a></div></div><div class="sp_person-sec__col3"><div class="sp_person-info"><div class="sp_person-info__hd">Ð—Ð´Ñ€Ð°Ð²ÑÑ‚Ð²ÑƒÐ¹Ñ‚Ðµ,</div><div class="sp_person-info__name">{{ user().user.name || \'Ð£Ð²Ð°Ð¶Ð°ÐµÐ¼Ñ‹Ð¹ Ð¿Ð¾ÐºÑƒÐ¿Ð°Ñ‚ÐµÐ»ÑŒ\' }}</div><div class="sp_person-info__cont"><div data-ng-show="user().user.email">{{ user().user.email }}</div><div data-ng-show="user().user.phone">{{ user().user.phone | tel }}<div class="tooltip"><span class="tooltip_icon">?</span> <span class="tooltip_text">Ð¢ÐµÐ»ÐµÑ„Ð¾Ð½ Ð’Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð¸Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ, Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð¸Ð² Ð·Ð°Ð¿Ñ€Ð¾Ñ Ð½Ð° Ð¿Ð¾Ñ‡Ñ‚Ñƒ <a href="mailto:change@bronnitsy.info">change@bronnitsy.info</a></span></div></div></div><div class="sp_person-info__status"><div class="sp_person-info__stat-hd">Ð’Ð°Ñˆ ÑÑ‚Ð°Ñ‚ÑƒÑ: {{ user().user_status.name }}</div><div data-ng-if="get_next()">Ð”Ð¾ ÑÑ‚Ð°Ñ‚ÑƒÑÐ° <b>{{ get_next().name }}</b> Ð¾ÑÑ‚Ð°Ð»Ð¾ÑÑŒ {{ get_offset() }} {{ get_offset() | sailplay_pluralize:\'Ð±Ð°Ð»Ð»,Ð±Ð°Ð»Ð»Ð°,Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</div></div></div></div></section><section class="sp_l-centered sp_info-sec"><div class="sp_info-sec__l"><div class="sp_points-cell"><div class="sp_points-cell__hd">Ð’Ð°ÑˆÐ¸ Ð±Ð°Ð»Ð»Ñ‹</div><div class="status-info-counter"><div class="status-info-counter__val">{{ user().user_points.confirmed }}</div><div class="status-info-counter__remain">+{{ user().user_points.unconfirmed }}<div class="status-info-counter__popup">ÐÐµÐ¿Ð¾Ð´Ñ‚Ð²ÐµÑ€Ð¶Ð´ÐµÐ½Ð½Ñ‹Ðµ Ð±Ð°Ð»Ð»Ñ‹, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ðµ Ð½Ð°Ñ‡Ð¸ÑÐ»ÑÑ‚ÑÑ Ð¿Ð¾ÑÐ»Ðµ Ð¾Ð¿Ð»Ð°Ñ‚Ñ‹</div></div></div><div class="sp_points-cell__ttl">{{ user().user_points.confirmed | sailplay_pluralize:\'Ð±Ð¾Ð½ÑƒÑÐ½Ñ‹Ð¹ Ð±Ð°Ð»Ð»,Ð±Ð¾Ð½ÑƒÑÐ½Ñ‹Ñ… Ð±Ð°Ð»Ð»Ð°,Ð±Ð¾Ð½ÑƒÑÐ½Ñ‹Ñ… Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</div><a href="" data-ng-hide="hide_hist" data-ng-click="show_history = true;" class="sp_cmn-btn sp_cmn-btn_red sp_points-cell__btn js-open-history-popup">Ð˜ÑÑ‚Ð¾Ñ€Ð¸Ñ Ñ‚Ñ€Ð°Ð½Ð·Ð°ÐºÑ†Ð¸Ð¹</a></div></div><div class="sp_info-sec__r"><div class="sp_status-cell"><div class="sp_status-cell__hd">Ð’Ð°Ñˆ ÑÑ‚Ð°Ñ‚ÑƒÑ:</div><div class="sp_status-cell__img" style="background-image: url({{ user().user_status.pic || \'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/e979ec44819f37ff84795afb2179a256.svg\' }});"></div><div class="sp_status-cell__ttl">{{ user().user_status.name || \'ÐÐµÑ‚ ÑÑ‚Ð°Ñ‚ÑƒÑÐ°\' }}</div><a href="" class="sp_cmn-btn sp_cmn-btn_red sp_status-cell__btn js-open-status-popup" data-ng-click="show_statuses_list = true;">Ð¡Ð¿Ð¸ÑÐ¾Ðº ÑÑ‚Ð°Ñ‚ÑƒÑÐ¾Ð²</a></div></div></section><section class="sp_l-centered sp_progr-sec" data-ng-if="get_next()"><div class="sp_progr-sec__l"><div class="sp_progr-sec__txt">Ð”Ð¾ ÑÐ»ÐµÐ´ÑŽÑ‰ÐµÐ³Ð¾ ÑÑ‚Ð°Ñ‚ÑƒÑÐ° Ð¾ÑÑ‚Ð°Ð»Ð¾ÑÑŒ <b>{{ get_offset() }} {{ get_offset() | sailplay_pluralize:\'Ð±Ð°Ð»Ð»,Ð±Ð°Ð»Ð»Ð°,Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</b></div></div><div class="sp_progr-sec__r"><div class="sp_progr-cell"><div class="sp_progr-bar js-status-bar" data-width="90"><div class="sp_progr-bar__inner"><div class="sp_progr-bar__inner-bar this-inner1 js-status-bar__inner" data-ng-style="{ width: get_progress() + \'%\' }"></div></div><div class="sp_progr-bar__point this-point-{{ $index+1 }}" data-ng-repeat="badge in badges().multilevel_badges[0]"><div class="sp_progr-bar__point-img" style="background-image: url(\'{{ badge.thumbs.url_250x250 | sailplay_pic }}\');"></div><div class="sp_progr-bar__point-name">{{ badge.name }}</div></div></div></div></div></section><section class="sp_l-section sp_gift-sec" data-sailplay-gifts="" data-ng-cloak="" data-ng-controller="slick_config" data-ng-init="selected_gift = false;"><div class="sp_cmn-sec-head">ÐŸÐ¾Ð´Ð°Ñ€ÐºÐ¸</div><div class="sp_gift-slider js-gift-slider" data-ng-if="gifts && gifts() && gifts().length" data-slick-carousel="" data-options="$parent.gift_slider_config"><div data-ng-repeat="gift in $parent.gifts()" data-slick-slide=""><div class="sp_gift-slider__slide"><div class="sp_gift-slider__img" style="background-image: url(\'{{ gift.thumbs.url_250x250 | sailplay_pic }}\');"></div><div class="sp_gift-slider__hd">{{ gift.name }}</div><div class="sp_gift-slider__ttl">{{ gift.descr }}</div><div class="sp_gift-slider__price">{{ gift.points }} {{ gift.points | sailplay_pluralize:\'Ð±Ð°Ð»Ð»,Ð±Ð°Ð»Ð»Ð°,Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</div><button style="line-height: 36px;" type="button" class="sp_cmn-btn-sm sp_gift-slider__btn js-open-gift-popup" data-ng-click="$parent.$parent.selected_gift = gift" data-ng-disabled="gift.points > $parent.user().user_points.confirmed">ÐŸÐ¾Ð»ÑƒÑ‡Ð¸Ñ‚ÑŒ</button></div></div></div><div class="sp_overlay display_table" data-ng-show="selected_gift"><div class="display_table_cell" data-overlay-click="selected_gift = false;"><div class="sp_gift-popup js-gift-popup"><div class="sp_gift-popup__hd">{{ selected_gift.points }} Ð±Ð¾Ð½ÑƒÑÐ½Ñ‹Ñ… Ð±Ð°Ð»Ð»Ð¾Ð² Ð±ÑƒÐ´ÑƒÑ‚ ÑÐ¿Ð¸ÑÐ°Ð½Ñ‹ Ñ Ð²Ð°ÑˆÐµÐ³Ð¾ ÑÑ‡ÐµÑ‚Ð°</div><div class="sp_gift-popup__img" style="background-image: url(\'{{ selected_gift.thumbs.url_250x250 | sailplay_pic }}\');"></div><div class="sp_gift-popup__ttl">Ð’Ñ‹ ÑƒÐ²ÐµÑ€ÐµÐ½Ñ‹?</div><div class="sp_gift-popup__btns"><div class="sp_gift-popup__btn sp_cmn-btn-sm js-close-popup" data-ng-click="gift_purchase(selected_gift); selected_gift = false;">Ð”Ð°</div><div class="sp_gift-popup__btn sp_cmn-btn-sm js-close-popup" data-ng-click="selected_gift = false;">ÐžÑ‚Ð¼ÐµÐ½Ð°</div></div></div></div></div></section><section class="sp_task-sec-wrap" data-sailplay-actions="" data-ng-cloak=""><div class="sp_l-section sp_task-sec" data-ng-controller="slick_config"><div class="sp_cmn-sec-head">Ð—Ð°Ð´Ð°Ð½Ð¸Ñ</div><div class="sp_task-slider js-task-slider" data-ng-if="actions && actions()" data-slick-carousel="" data-options="action_slider_config"><div data-slick-slide="" data-ng-show="show_profile_action"><div class="sp_task-slider__slide"><div class="sp_task-slider__ico" style="background-image: url(\'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/e979ec44819f37ff84795afb2179a256.svg\');"></div><div class="sp_task-slider__hd">Ð—Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»ÑŒ</div><div class="sp_task-slider__price">{{ 100 }} {{ 100 | sailplay_pluralize:\'Ð±Ð°Ð»Ð»,Ð±Ð°Ð»Ð»Ð°,Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</div><div class="sp_task-slider__cover"><a class="sp_cmn-btn-sm sp_task-slider__btn" data-ng-click="open_profile()">Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ</a></div></div></div><div data-ng-repeat="action in $parent.actions().actions" data-slick-slide=""><div class="sp_task-slider__slide"><div class="sp_task-slider__ico" style="background-image: url({{ action_data(action).pic }});"></div><div class="sp_task-slider__hd">{{ action_data(action).name }}</div><div class="sp_task-slider__price">{{ action.points }} {{ action.points | sailplay_pluralize:\'Ð±Ð°Ð»Ð»,Ð±Ð°Ð»Ð»Ð°,Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</div><div class="sp_task-slider__cover"><span class="sp_cmn-btn-sm sp_task-slider__btn" data-sailplay-action="" data-action="action" data-text="Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ" data-styles="{{ config.social_styles || \'https://d3sailplay.cdnvideo.ru/media/assets/assetfile/e8f73ebedc5f336aa857674149750d3b.css\' }}">Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ</span></div></div></div></div></div></section></div><div class="sp_overlay display_table" data-ng-show="show_history"><div class="display_table_cell" data-overlay-click="show_history = false;"><div class="sp_hist-popup js-history-popup"><div class="sp_cmn-popup-close js-close-popup" data-ng-click="show_history = false;"></div><div class="sp_hist-popup__hd">Ð˜ÑÑ‚Ð¾Ñ€Ð¸Ñ Ñ‚Ñ€Ð°Ð½Ð·Ð°ÐºÑ†Ð¸Ð¹</div><div class="sp_hist-list"><div class="sp_hist-list__itm" data-dir-paginate="item in history() | itemsPerPage:10" data-pagination-id="history_pages" data-ng-class="{ \'this-dec\': item.points_delta < 0 }"><div class="sp_hist-list__val">{{ item.points_delta || 0 }} {{ item.points_delta | sailplay_pluralize:\'Ð±Ð°Ð»Ð»,Ð±Ð°Ð»Ð»Ð°,Ð±Ð°Ð»Ð»Ð¾Ð²\' }}</div>{{ item | history_item }}</div></div><dir-pagination-controls data-max-size="5" data-pagination-id="history_pages" data-template-url="/html/ui/ui.pagination.controls.html" data-auto-hide="true"></dir-pagination-controls></div></div></div><div class="sp_overlay" data-ng-show="show_statuses_list"><div class="sp_stat-popup js-status-popup"><div class="sp_stat-popup__hd">ÐžÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ ÑÑ‚Ð°Ñ‚ÑƒÑÐ¾Ð²</div><div class="sp_stat-pop-itm" data-ng-repeat="badge in badges().multilevel_badges[0]"><div class="sp_stat-pop-itm__img"><img data-ng-src="{{ badge.thumbs.url_250x250 | sailplay_pic }}" alt=""></div><div class="sp_stat-pop-itm__text">{{ badge.descr }}</div></div><div class="sp_stat-popup__btns"><div class="sp_stat-popup__btn sp_cmn-btn-sm js-close-popup" data-ng-click="show_statuses_list = false;">ÐžÐš</div></div></div></div><div class="sp_overlay" data-ng-show="show_profile_info" data-overlay-click="show_profile_info = false; body_lock(false)"><div class="sp_profile-popup js-profile-popup" data-fill-profile=""><div class="sp_profile-popup__hd">Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»ÑŒ</div><form class="sp_profile-form" name="fill_profile" novalidate="" data-ng-submit="$event.preventDefault(); submit_profile(fill_profile, $parent.close_profile)"><div class="sp_profile-form__set"><input type="email" name="email" class="sp_cmn-input" placeholder="Email" data-ng-model="profile_form.user.addEmail" data-ng-model-options="{ updateOn: \'default change blur\' }" required=""></div><div class="sp_profile-form__set" data-ng-if="profile_form.user.birthDate"><div class="sp_profile-form__ttl">Ð”Ð°Ñ‚Ð° Ñ€Ð¾Ð¶Ð´ÐµÐ½Ð¸Ñ</div><div class="sp_profile-form__dates" data-date-selector="" data-ng-model="$parent.profile_form.user.birthDate"><div class="sp_profile-form__dates-col"><select name="birth_date" data-ng-model="selected_date[0]" data-selectize="" class="js-create-select sp_cmn-selectize"><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select></div><div class="sp_profile-form__dates-col"><select name="birth_date" data-ng-model="selected_date[1]" data-selectize="" class="js-create-select sp_cmn-selectize"><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select></div><div class="sp_profile-form__dates-col"><select name="birth_date" data-ng-model="selected_date[2]" data-selectize="" class="js-create-select sp_cmn-selectize"><option value="1924">1924</option><option value="1925">1925</option><option value="1926">1926</option><option value="1927">1927</option><option value="1928">1928</option><option value="1929">1929</option><option value="1930">1930</option><option value="1931">1931</option><option value="1932">1932</option><option value="1933">1933</option><option value="1934">1934</option><option value="1935">1935</option><option value="1936">1936</option><option value="1937">1937</option><option value="1938">1938</option><option value="1939">1939</option><option value="1940">1940</option><option value="1941">1941</option><option value="1942">1942</option><option value="1943">1943</option><option value="1944">1944</option><option value="1945">1945</option><option value="1946">1946</option><option value="1947">1947</option><option value="1948">1948</option><option value="1949">1949</option><option value="1950">1950</option><option value="1951">1951</option><option value="1952">1952</option><option value="1953">1953</option><option value="1954">1954</option><option value="1955">1955</option><option value="1956">1956</option><option value="1957">1957</option><option value="1958">1958</option><option value="1959">1959</option><option value="1960">1960</option><option value="1961">1961</option><option value="1962">1962</option><option value="1963">1963</option><option value="1964">1964</option><option value="1965">1965</option><option value="1966">1966</option><option value="1967">1967</option><option value="1968">1968</option><option value="1969">1969</option><option value="1970">1970</option><option value="1971">1971</option><option value="1972">1972</option><option value="1973">1973</option><option value="1974">1974</option><option value="1975">1975</option><option value="1976">1976</option><option value="1977">1977</option><option value="1978">1978</option><option value="1979">1979</option><option value="1980">1980</option><option value="1981">1981</option><option value="1982">1982</option><option value="1983">1983</option><option value="1984">1984</option><option value="1985">1985</option><option value="1986">1986</option><option value="1987">1987</option><option value="1988">1988</option><option value="1989">1989</option><option value="1990">1990</option><option value="1991">1991</option><option value="1992">1992</option><option value="1993">1993</option><option value="1994">1994</option><option value="1995">1995</option><option value="1996">1996</option><option value="1997">1997</option><option value="1998">1998</option><option value="1999">1999</option><option value="2000">2000</option><option value="2001">2001</option><option value="2002">2002</option><option value="2003">2003</option><option value="2004">2004</option><option value="2005">2005</option><option value="2006">2006</option><option value="2007">2007</option><option value="2008">2008</option><option value="2009">2009</option></select></div></div></div><div class="sp_profile-form__set"><div class="sp_cmn-inline-param"><label class="outer_label radio" data-ng-class="{ checked: profile_form.custom_vars[\'Ð’ Ð±Ñ€Ð°ÐºÐµ\'] === \'Ð´Ð°\' }"><input name="married" type="radio" class="js-create-radio" data-ng-value="\'Ð´Ð°\'" data-ng-model="profile_form.custom_vars[\'Ð’ Ð±Ñ€Ð°ÐºÐµ\']"> <span class="sp_cmn-label js-satellite">Ð—Ð°Ð¼ÑƒÐ¶ÐµÐ¼/Ð¶ÐµÐ½Ð°Ñ‚</span></label></div><div class="sp_cmn-inline-param"><label class="outer_label radio" data-ng-class="{ checked: profile_form.custom_vars[\'Ð’ Ð±Ñ€Ð°ÐºÐµ\'] === \'Ð½ÐµÑ‚\' }"><input name="married" type="radio" class="js-create-radio" data-ng-value="\'Ð½ÐµÑ‚\'" data-ng-model="profile_form.custom_vars[\'Ð’ Ð±Ñ€Ð°ÐºÐµ\']"> <span class="sp_cmn-label js-satellite">ÐÐµ Ð·Ð°Ð¼ÑƒÐ¶ÐµÐ¼/Ð¥Ð¾Ð»Ð¾ÑÑ‚</span></label></div></div><div class="sp_profile-form__set"><input type="text" class="sp_cmn-input" placeholder="Ð˜Ð¼Ñ ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°/ÑÑƒÐ¿Ñ€ÑƒÐ³Ð¸" data-ng-model="profile_form.custom_vars[\'Ð˜Ð¼Ñ ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°(Ð¸)\']"></div><div class="sp_profile-form__set" data-ng-if="profile_form.custom_vars[\'Ð”Ð  ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°(Ð¸)\']"><div class="sp_profile-form__ttl">Ð”Ð°Ñ‚Ð° Ñ€Ð¾Ð¶Ð´ÐµÐ½Ð¸Ñ ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°/ÑÑƒÐ¿Ñ€ÑƒÐ³Ð¸</div><div class="sp_profile-form__dates" data-date-selector="" data-ng-model="$parent.profile_form.custom_vars[\'Ð”Ð  ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°(Ð¸)\']"><div class="sp_profile-form__dates-col"><select name="married_date" data-ng-model="selected_date[0]" data-selectize="" class="js-create-select sp_cmn-selectize"><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select></div><div class="sp_profile-form__dates-col"><select name="married_date" data-ng-model="selected_date[1]" data-selectize="" class="js-create-select sp_cmn-selectize"><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select></div><div class="sp_profile-form__dates-col"><select name="married_date" data-ng-model="selected_date[2]" data-selectize="" class="js-create-select sp_cmn-selectize"><option value="1924">1924</option><option value="1925">1925</option><option value="1926">1926</option><option value="1927">1927</option><option value="1928">1928</option><option value="1929">1929</option><option value="1930">1930</option><option value="1931">1931</option><option value="1932">1932</option><option value="1933">1933</option><option value="1934">1934</option><option value="1935">1935</option><option value="1936">1936</option><option value="1937">1937</option><option value="1938">1938</option><option value="1939">1939</option><option value="1940">1940</option><option value="1941">1941</option><option value="1942">1942</option><option value="1943">1943</option><option value="1944">1944</option><option value="1945">1945</option><option value="1946">1946</option><option value="1947">1947</option><option value="1948">1948</option><option value="1949">1949</option><option value="1950">1950</option><option value="1951">1951</option><option value="1952">1952</option><option value="1953">1953</option><option value="1954">1954</option><option value="1955">1955</option><option value="1956">1956</option><option value="1957">1957</option><option value="1958">1958</option><option value="1959">1959</option><option value="1960">1960</option><option value="1961">1961</option><option value="1962">1962</option><option value="1963">1963</option><option value="1964">1964</option><option value="1965">1965</option><option value="1966">1966</option><option value="1967">1967</option><option value="1968">1968</option><option value="1969">1969</option><option value="1970">1970</option><option value="1971">1971</option><option value="1972">1972</option><option value="1973">1973</option><option value="1974">1974</option><option value="1975">1975</option><option value="1976">1976</option><option value="1977">1977</option><option value="1978">1978</option><option value="1979">1979</option><option value="1980">1980</option><option value="1981">1981</option><option value="1982">1982</option><option value="1983">1983</option><option value="1984">1984</option><option value="1985">1985</option><option value="1986">1986</option><option value="1987">1987</option><option value="1988">1988</option><option value="1989">1989</option><option value="1990">1990</option><option value="1991">1991</option><option value="1992">1992</option><option value="1993">1993</option><option value="1994">1994</option><option value="1995">1995</option><option value="1996">1996</option><option value="1997">1997</option><option value="1998">1998</option><option value="1999">1999</option><option value="2000">2000</option><option value="2001">2001</option><option value="2002">2002</option><option value="2003">2003</option><option value="2004">2004</option><option value="2005">2005</option><option value="2006">2006</option><option value="2007">2007</option><option value="2008">2008</option><option value="2009">2009</option></select></div></div></div><div class="sp_profile-form__set"><div class="sp_cmn-inline-param"><label class="outer_label checkbox" data-ng-class="{ checked: profile_form.custom_vars[\'Ð”ÐµÑ‚Ð¸\'] === \'Ð”Ð°\' }"><input name="checkboxname" type="checkbox" class="js-create-checkbox" data-ng-model="profile_form.custom_vars[\'Ð”ÐµÑ‚Ð¸\']" data-ng-true-value="\'Ð”Ð°\'" data-ng-false-value="\'ÐÐµÑ‚\'"> <span class="sp_cmn-label js-satellite">Ð•ÑÑ‚ÑŒ Ð´ÐµÑ‚Ð¸</span></label></div></div><div class="sp_profile-form__set"><div class="sp_profile-form__ttl">Ð¡ÐºÑ€Ñ‹Ð²Ð°Ñ‚ÑŒ Ð¸ÑÑ‚Ð¾Ñ€Ð¸ÑŽ Ñ‚Ñ€Ð°Ð½Ð·Ð°ÐºÑ†Ð¸Ð¸</div><div class="sp_cmn-inline-param"><label class="outer_label radio" data-ng-class="{ checked: profile_form.custom_vars.hide_hist === \'Ð”Ð°\' }"><input name="hide_hist" type="radio" class="js-create-radio" data-ng-value="\'Ð”Ð°\'" data-ng-model="profile_form.custom_vars.hide_hist"> <span class="sp_cmn-label js-satellite">Ð”Ð°</span></label></div><div class="sp_cmn-inline-param"><label class="outer_label radio" data-ng-class="{ checked: profile_form.custom_vars.hide_hist === \'ÐÐµÑ‚\' }"><input name="hide_hist" type="radio" class="js-create-radio" data-ng-value="\'ÐÐµÑ‚\'" data-ng-model="profile_form.custom_vars.hide_hist"> <span class="sp_cmn-label js-satellite">ÐÐµÑ‚</span></label></div></div><div class="sp_profile-form__btns"><button type="submit" class="sp_cmn-btn-sm sp_profile-form__btn" data-ng-disabled="!fill_profile.$valid">ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ</button> <a href="#" class="sp_cmn-btn-sm sp_profile-form__btn js-close-popup" data-ng-click="$parent.show_profile_info = false; $parent.body_lock(false);">ÐžÑ‚Ð¼ÐµÐ½Ð°</a></div></form></div></div><notifier></notifier></div>');
  }]);
})();
      ...
      return {
        ...
        link: function (scope) {
          ...
          scope.close_profile = function () {
            ...
            scope.hide_hist = ipCookie('profile_form') && ipCookie('profile_form').custom_vars.hide_hist === 'Ð”Ð°';
...
(function () {
  ...
  angular.module('ui', [
    ...
    .constant('ProfileTag', 'ÐšÐ»Ð¸ÐµÐ½Ñ‚ Ð·Ð°Ð¿Ð¾Ð»Ð½Ð¸Ð» Ð¿Ñ€Ð¾Ñ„Ð¸Ð»ÑŒ')
        ...
        link: function(scope){
          ...
          scope.$watch(function(){
            ...
            if(ipCookie('profile_form') && SailPlay.config().auth_hash === ipCookie('profile_form').user.auth_hash ){
              ...
              scope.profile_form.custom_vars['Ð”Ð  ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°(Ð¸)'] = ipCookie('profile_form') ? ipCookie('profile_form').custom_vars['Ð”Ð  ÑÑƒÐ¿Ñ€ÑƒÐ³Ð°(Ð¸)'] : '0000-00-00';
            }
            ...
            SailPlay.send('users.update', req_user, function(user_res){
              ...
              if(user_res.status === 'ok'){
                  ...
                  SailPlay.send('vars.add', { custom_vars: scope.profile_form.custom_vars }, function(vars_res){
                    ...
                    if(vars_res.status === 'ok') {
                      ...
                      $rootScope.$broadcast('notifier:notify', {
                        ...
                        header: 'Ð¡Ð¿Ð°ÑÐ¸Ð±Ð¾',
                        body: 'Ð”Ð°Ð½Ð½Ñ‹Ðµ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»Ñ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ñ‹'
                      ...
                      $rootScope.$broadcast('notifier:notify', {
                        ...
                        header: 'ÐžÑˆÐ¸Ð±ÐºÐ°',
                        body: user_res.message || 'Ðš ÑÐ¾Ð¶Ð°Ð»ÐµÐ½Ð¸ÑŽ Ð¿Ñ€Ð¾Ð¸Ð·Ð¾ÑˆÐ»Ð° Ð¾ÑˆÐ¸Ð±ÐºÐ°'
                ...
                $rootScope.$broadcast('notifier:notify', {
                  ...
                  header: 'ÐžÑˆÐ¸Ð±ÐºÐ°',
                  body: $rootScope.locale.errors[user_res.status_code] || $rootScope.locale.errors[user_res.message] || 'Ðš ÑÐ¾Ð¶Ð°Ð»ÐµÐ½Ð¸ÑŽ Ð¿Ñ€Ð¾Ð¸Ð·Ð¾ÑˆÐ»Ð° Ð¾ÑˆÐ¸Ð±ÐºÐ°'
