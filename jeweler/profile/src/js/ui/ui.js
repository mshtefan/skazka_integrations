...
//templates
import NotifierTemplate from '../../html/ui/ui.notifier.html';

let Ui = angular.module('ui', [
  NgPagination
])
      ...
      link: function (scope) {
        ...
        var new_form = {
          ...
          user: {
            ...
            addPhone: '', addEmail: '', birthDate: ''

          }, custom_vars: {

            'В браке': '', 'Имя супруга(и)': '', 'ДР супруга(и)': '', 'Дети': 'Нет', 'hide_hist': 'Нет'

          }, tags: [], hide_hist: false
                ...
                SailPlay.send('vars.add', {custom_vars: _variables}, function (vars_res) {
                  ...
                  if (vars_res.status === 'ok') {
                    ...
                    $rootScope.$broadcast('notifier:notify', {
                      ...
                      header: 'Спасибо', body: 'Данные профиля сохранены'
                    ...
                    $rootScope.$broadcast('notifier:notify', {
                      ...
                      header: 'Ошибка', body: user_res.message || 'К сожалению произошла ошибка'
  ...
  .directive('overlayClick', function () {
    ...
    return {
      restrict: 'A', replace: false, scope: false, link: function (scope, elm, attrs) {
    ...
    return {
      restrict: 'A', link: function (scope, element, attrs) {
        ...
        var options = scope.$eval(attrs.options) || {
            ...
            slidesToScroll: 4,
            responsive: [{
              breakpoint: 1190, settings: {
                slidesToShow: 4, slidesToScroll: 4
              }
            }, {
              breakpoint: 880, settings: {
  ...
  .directive('dateSelector', function ($parse) {
    ...
    return {
      restrict: 'A', require: 'ngModel', scope: true, link: function (scope, elm, attrs, ngModelCtrl) {
