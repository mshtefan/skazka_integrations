...
function getMobileOperatingSystem(){var a=navigator.userAgent||navigator.vendor||window.opera;return/windows phone/i.test(a)?"Windows Phone":/android/i.test(a)?"Android":/iPad|iPhone|iPod/.test(a)&&!window.MSStream?"iOS":"unknown"}!function(){"use strict";angular.module("ui.mask",[]).value("uiMaskConfig",{maskDefinitions:{9:/\d/,A:/[a-zA-Z]/,"*":/[a-zA-Z0-9]/},clearOnBlur:!0,eventsToHandle:["input","keyup","click","focus"]}).directive("uiMask",["uiMaskConfig",function(a){function b(a){return a===document.activeElement&&(!document.hasFocus||document.hasFocus())&&!!(a.type||a.href||~a.tabIndex)}return{priority:100,require:"ngModel",restrict:"A",compile:function(){var c=a;return function(a,d,e,f){function g(a){return angular.isDefined(a)?(t(a),P?(l(),m(),!0):k()):k()}function h(a){a&&(F=a,P&&d.val(q(p(d.val()))))}function i(a){return P?(I=p(a||""),K=o(I),f.$setValidity("mask",K),K&&I.length?q(I):void 0):a}function j(a){return P?(I=p(a||""),K=o(I),f.$viewValue=I.length?q(I):"",f.$setValidity("mask",K),""===I&&e.required&&f.$setValidity("required",!f.$error.required),K?T?f.$viewValue:I:void 0):a}function k(){return P=!1,n(),angular.isDefined(R)?d.attr("placeholder",R):d.removeAttr("placeholder"),angular.isDefined(S)?d.attr("maxlength",S):d.removeAttr("maxlength"),d.val(f.$modelValue),f.$viewValue=f.$modelValue,!1}function l(){I=M=p(f.$modelValue||""),J=L=q(I),K=o(I),e.maxlength&&d.attr("maxlength",2*D[D.length-1]),R||d.attr("placeholder",F);for(var a=f.$modelValue,b=f.$formatters.length;b--;)a=f.$formatters[b](a);f.$viewValue=a||"",f.$render()}function m(){Q||(d.bind("blur",u),d.bind("mousedown mouseup",v),d.bind(U.eventsToHandle.join(" "),y),d.bind("paste",x),Q=!0)}function n(){Q&&(d.unbind("blur",u),d.unbind("mousedown",v),d.unbind("mouseup",v),d.unbind("input",y),d.unbind("keyup",y),d.unbind("click",y),d.unbind("focus",y),d.unbind("paste",x),Q=!1)}function o(a){return!a.length||a.length>=H}function p(a){var b="",c=E.slice();return a=a.toString(),angular.forEach(G,function(b){a=a.replace(b,"")}),angular.forEach(a.split(""),function(a){c.length&&c[0].test(a)&&(b+=a,c.shift())}),b}function q(a){var b="",c=D.slice();return angular.forEach(F.split(""),function(d,e){a.length&&e===c[0]?(b+=a.charAt(0)||"_",a=a.substr(1),c.shift()):b+=d}),b}function r(a){var b=angular.isDefined(e.uiMaskPlaceholder)?e.uiMaskPlaceholder:e.placeholder;return void 0!==b&&b[a]?b[a]:"_"}function s(){return F.replace(/[_]+/g,"_").replace(/([^_]+)([a-zA-Z0-9])([^_])/g,"$1$2_$3").split("_")}function t(a){var b=0;if(D=[],E=[],F="","string"==typeof a){H=0;var c=!1,d=0,e=a.split("");angular.forEach(e,function(a,e){U.maskDefinitions[a]?(D.push(b),F+=r(e-d),E.push(U.maskDefinitions[a]),b++,c||H++):"?"===a?(c=!0,d++):(F+=a,b++)})}D.push(D.slice().pop()+1),G=s(),P=D.length>1}function u(){U.clearOnBlur&&(N=0,O=0,K&&0!==I.length||(J="",d.val(""),a.$apply(function(){f.$setViewValue("")})))}function v(a){"mousedown"===a.type?d.bind("mouseout",w):d.unbind("mouseout",w)}function w(){O=C(this),d.unbind("mouseout",w)}function x(){B(this,d.val().length)}function y(a){a=a||{};var b=a.which,c=a.type;if(16!==b&&91!==b){var e,g=d.val(),h=L,i=p(g),j=M,k=A(this)||0,l=N||0,m=k-l,n=D[0],o=D[i.length]||D.slice().shift(),r=O||0,s=C(this)>0,t=r>0,u=g.length>h.length||r&&g.length>h.length-r,v=g.length<h.length||r&&g.length===h.length-r,w=b>=37&&40>=b&&a.shiftKey,x=37===b,y=8===b||"keyup"!==c&&v&&-1===m,E=46===b||"keyup"!==c&&v&&0===m&&!t,F=(x||y||"click"===c)&&k>n;if(O=C(this),!w&&(!s||"click"!==c&&"keyup"!==c)){if("input"===c&&v&&!t&&i===j){for(;y&&k>n&&!z(k);)k--;for(;E&&o>k&&-1===D.indexOf(k);)k++;var G=D.indexOf(k);i=i.substring(0,G)+i.substring(G+1)}for(e=q(i),L=e,M=i,d.val(e),f.$setViewValue(i),u&&n>=k&&(k=n+1),F&&k--,k=k>o?o:n>k?n:k;!z(k)&&k>n&&o>k;)k+=F?-1:1;(F&&o>k||u&&!z(l))&&k++,N=k,B(this,k)}}}function z(a){return D.indexOf(a)>-1}function A(a){if(!a)return 0;if(void 0!==a.selectionStart)return a.selectionStart;if(document.selection&&b(d[0])){a.focus();var c=document.selection.createRange();return c.moveStart("character",a.value?-a.value.length:0),c.text.length}return 0}function B(a,c){if(!a)return 0;if(0!==a.offsetWidth&&0!==a.offsetHeight)if(a.setSelectionRange)b(d[0])&&(a.focus(),a.setSelectionRange(c,c));else if(a.createTextRange){var e=a.createTextRange();e.collapse(!0),e.moveEnd("character",c),e.moveStart("character",c),e.select()}}function C(a){return a?void 0!==a.selectionStart?a.selectionEnd-a.selectionStart:document.selection?document.selection.createRange().text.length:0:0}var D,E,F,G,H,I,J,K,L,M,N,O,P=!1,Q=!1,R=e.placeholder,S=e.maxlength,T=!1;e.$observe("modelViewValue",function(a){"true"===a&&(T=!0)});var U={};e.uiOptions?(U=a.$eval("["+e.uiOptions+"]"),angular.isObject(U[0])&&(U=function(a,b){for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(void 0===b[c]?b[c]=angular.copy(a[c]):angular.isObject(b[c])&&angular.extend(b[c],a[c]));return b}(c,U[0]))):U=c,e.$observe("uiMask",g),angular.isDefined(e.uiMaskPlaceholder)?e.$observe("uiMaskPlaceholder",h):e.$observe("placeholder",h),f.$formatters.push(i),f.$parsers.push(j),d.bind("mousedown mouseup",v),Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null===this)throw new TypeError;var b=Object(this),c=b.length>>>0;if(0===c)return-1;var d=0;if(arguments.length>1&&(d=Number(arguments[1]),d!==d?d=0:0!==d&&d!==1/0&&d!==-1/0&&(d=(d>0||-1)*Math.floor(Math.abs(d)))),d>=c)return-1;for(var e=d>=0?d:Math.max(c-Math.abs(d),0);c>e;e++)if(e in b&&b[e]===a)return e;return-1})}}}}])}(),function(a){a.angular&&angular.module("mno.data",[]).constant("data",{cities:[{name:"Архангельск",clinics:["Первая городская клиническая больница скорой медицинской помощи им Е.Е. Волосевич"]},{name:"Архангельская область, г. Няндома",clinics:['ГБУЗ АО "Няндомская ЦРБ"']},{name:"Архангельская область, г. Северодвинск",clinics:["Поликлиника №3"]},{name:"Волгоград",clinics:["Областной кардиологический центр"]},{name:"Воронеж",clinics:["Воронежская областная клиническая больница №1",'Поликлиника "Дубрава"']},{name:"Екатеринбург",clinics:["Клиника Уральская"]},{name:"Казань",clinics:['Медико-санитарная часть ФГАОУ ВО КФУ (Университетская клиника "Казань")']},{name:"Калуга",clinics:["Калужская Областная Больница"]},{name:"Кемерово",clinics:['МБУЗ "Кемеровский кардиологический диспансер", поликлиника, 3 эт. холл поликлиники']},{name:"Краснодар",clinics:["ГБУЗ Краевая клиническая больница №2; поликлиника центра СКАЛ, процедурный кабинет, холл 1 этажа"]},{name:"Москва",clinics:["Первый МГМУ им. И.М. Сеченова, Университетская клиническая больница № 1"]},{name:"Нижегородская область, г. Кстово",clinics:['Медицинский центр "НИКА СПРИНГ"']},{name:"Нижний Новгород",clinics:['Медицинский центр "НИКА СПРИНГ", ул. Культуры д.2, кабинет кардиолога','Медицинский центр "НИКА СПРИНГ", ул. Горького д.226, кабинет кардиолога','Медицинский центр "НИКА СПРИНГ", Казанское шоссе д.10/6, пункт забора крови']},{name:"Новосибирск",clinics:["Новосибирский областной клинический кардиологический диспансер, 1 этаж поликлиники, кабинет № 5"]},{name:"Пермь",clinics:['ГБУЗ ПК "Клинический кардиологический диспансер", поликлиника, 2 эт. каб. 12']},{name:"Самара",clinics:["Самарский диагностический центр"]},{name:"Санкт-Петербург",clinics:["ФГБУ «ФМИЦ им. В. А. Алмазова», ул. Аккуратова д. 2",'Спб ГБУЗ "Городская Мариинская больница"',"Спб ГБУЗ ГКДЦ №1"]},{name:"Тюмень",clinics:["Тюменский кардиологический центр, 2 эт., зимний сад."]},{name:"Челябинск",clinics:["Областная клиническая больница №3, поликлиника, 2 эт. 235 каб."]}]})}(window);var SAILPLAY=function(a,b){var c={};if("unknown"==getMobileOperatingSystem())var d='<div class="__sp__lead_autocomplete __sp__dates __centered" style="width: 24%;" data-ng-init="show_day_selector = false;" data-ng-class="{ state_show_list: show_day_selector }"><div class="__sp__lead_dropdown_overlay" data-ng-click="show_day_selector = false;"></div><div data-ng-click="show_day_selector = !show_day_selector"><span class="__sp__field_value">{{ birth_date_obj[2] || \'День\' }}</span></div><div class="suggestion_wrapper"><ul><li data-ng-repeat="day in dates.days()" data-ng-click="birth_date_obj[2] = day; set_birth_date(); $parent.show_day_selector = false;">{{ day }}</li></ul></div></div><div class="__sp__lead_autocomplete __sp__dates __centered" style="width: 40%;" data-ng-init="show_month_selector = false;" data-ng-class="{ state_show_list: show_month_selector }"><div class="__sp__lead_dropdown_overlay" data-ng-click="show_month_selector = false;"></div><div data-ng-click="show_month_selector = !show_month_selector"><span class="__sp__field_value">{{ dates.months()[birth_date_obj[1]] || \'Месяц\' }}</span></div><div class="suggestion_wrapper"><ul><li data-ng-repeat="(num,month) in dates.months()" data-ng-click="birth_date_obj[1] = num; set_birth_date(); $parent.show_month_selector = false;">{{ month }}</li></ul></div></div><div class="__sp__lead_autocomplete __sp__dates __centered" style="width: 32%;" data-ng-init="show_year_selector = false;" data-ng-class="{ state_show_list: show_year_selector }"><div class="__sp__lead_dropdown_overlay" data-ng-click="show_year_selector = false;"></div><div data-ng-click="show_year_selector = !show_year_selector"><span class="__sp__field_value">{{ birth_date_obj[0] || \'Год\' }}</span></div><div class="suggestion_wrapper"><ul><li data-ng-repeat="year in dates.years()" data-ng-click="birth_date_obj[0] = year; set_birth_date(); $parent.show_year_selector = false;">{{ year }}</li></ul></div></div>',e="";else var d='<input type="date" max="2000-01-01">',e="for_mobile";return angular.module("mno.lead",["mno.data","ui.mask"]).constant("config",{partner_id:1438,domain:"http://sailplay.ru",additional_tags:b.getElementById("__sp__roche")&&b.getElementById("__sp__roche").getAttribute("data-tags")&&b.getElementById("__sp__roche").getAttribute("data-tags").split(",")}).directive("visavisMno",["data","sailplay","dates","config",function(a,b,f,g){return{restrict:"E",replace:!0,template:'<div class="__sp__lead_wrapper" data-ng-cloak data-ng-show="is_show_lead" data-ng-click="hide_lead($event)"><link rel="stylesheet" type="text/css" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css"><form class="__sp__lead_form" data-ng-show="!form_submitted" data-ng-submit="submit_lead()"><div class="__sp__lead_cancel ion-close-round" data-ng-click="hide_lead()"></div><div class="__sp__lead_inner"><div class="__sp__lead_title">Бесплатная регистрация в социальной Акции "День МНО"</div><div class="__sp_lead_field"><div class="__sp__lead_error" data-ng-show="!is_valid()">Пожалуйста, заполните все поля анкеты</div><input type="text" data-ng-model="form.lastName" placeholder="Фамилия"/></div><div class="__sp_lead_field"><input type="text" data-ng-model="form.firstName" placeholder="Имя" /></div><div class="__sp_lead_field"><input type="text" data-ng-model="form.middleName" placeholder="Отчество" /></div><div class="__sp_lead_field"><input type="text" data-ng-model="form.phone" placeholder="+_ (___) ___-____" data-ui-mask="+9 (999) 999-9999"/></div><div class="__sp_lead_field"><span class="__sp_lead_policy_help" style="margin: 2px 0 4px 2px;">День рождения</span></br>'+d+'</div><div class="__sp_lead_field"><div class="__sp__lead_autocomplete __sp__dates '+e+'" data-ng-init="show_city_selector = false;" data-ng-class="{ state_show_list: show_city_selector }"><div class="__sp__lead_dropdown_overlay" data-ng-click="show_city_selector = false;"></div><div data-ng-click="show_city_selector = !show_city_selector"><span class="__sp__field_value __sp__text_left">{{ tags[0] || \'Город\' }}</span></div><div class="suggestion_wrapper"><ul><li data-ng-repeat="city in data.cities" data-ng-click="tags[0] = city.name; tags[1] = \'\'; $parent.show_city_selector = false;">{{ city.name }}</li></ul></div></div></div><div class="__sp_lead_field"><div class="__sp__lead_autocomplete __sp__dates '+e+'" data-ng-init="show_clinic_selector = false;" data-ng-class="{ state_show_list: show_clinic_selector }"><div class="__sp__lead_dropdown_overlay" data-ng-click="show_clinic_selector = false;"></div><div data-ng-click="show_clinic_selector = !show_clinic_selector"><span class="__sp__field_value __sp__text_left">{{ tags[1] || \'Лечебно профилактическое учреждение\' }}</span></div><div class="suggestion_wrapper"><ul><li data-ng-repeat="clinic in get_clinics(tags[0])" data-ng-click="tags[1] = clinic; $parent.show_clinic_selector = false;">{{ clinic }}</li></ul></div></div></div><div class="__sp_lead_field"><span class="__sp_lead_policy_help"><span class="__sp_lead_policy_check" data-ng-class="{ checked: policy_accept }" data-ng-click="policy_accept = !policy_accept"><i class="ion-checkmark-round" data-ng-show="policy_accept"></i></span>Регистрируясь на сайте <a href="http://www.mnoportal.ru">www.mnoportal.ru</a>, я даю согласие входящим в группу компаний "Рош" лицам, в том числе компании «Roche Diagnostics GmbH» и ООО "Рош Диагностика Рус", на обработку указанных данных (сбор, запись, систематизацию, накопление, хранение, уточнение, извлечение, использование, передачу (включая трансграничную передачу), обезличивание, блокирование, удаление, уничтожение. Настоящее согласие выдается в целях регистрации в акции "День МНО" и информирования меня, как потребителя, о новых продуктах и услугах, предлагаемых ООО «Рош Диагностика Рус» на 5 (пять) лет и может быть отозвано по моему письменному заявлению, отправленному в адрес ООО «Рош Диагностика Рус». По истечении указанного срока действие согласия считается продлённым на каждые следующие пять лет при отсутствии моего письменного отзыва, отправленного в адрес ООО «Рош Диагностика Рус»</span></div></div><div class="__sp_lead_policy_agreement" data-ng-show="show_policy_rules"><div class="__sp__lead_cancel ion-close-round" data-ng-click="show_policy_rules = false;"></div><div class="__sp_lead_warning" data-ng-show="policy_accept_notify">ВНИМАНИЕ, ПЕРЕД РЕГИСТРАЦИЕЙ ОЗНАКОМЬТЕСЬ С ИНФОРМАЦИЕЙ</div>МНО (международное нормализованное отношение) - показатель свертываемости крови, который необходимо регулярно, как минимум раз в месяц, измерять пациентам, принимающим непрямые антикоагулянты (например: варфарин, маркумар, синкумар, фенилин и др.) </br></br> <strong>О необходимости измерения показателя МНО проконсультируйтесь со своим лечащим врачом или по телефону бесплатной горячей линии </br> 8-800-100-19-68.</strong></div><button data-ng-if="policy_accept_notify" class="__sp_lead_submit_btn" data-ng-disabled="!policy_accept" type="submit"><span>ЗАВЕРШИТЬ РЕГИСТРАЦИЮ <i class="ion-chevron-right"></i></span></button><button data-ng-if="!policy_accept_notify" class="__sp_lead_submit_btn" data-ng-disabled="!policy_accept || !is_valid()" type="submit">ПРОДОЛЖИТЬ <i class="ion-chevron-right"></i></button></form><div class="__sp__lead_form __submitted" data-ng-show="form_submitted"><div class="__sp__lead_cancel ion-close-round" data-ng-click="hide_lead();"></div><div class="__sp__lead_inner">Спасибо, что зарегистрировались, ждем Вас на акции "День МНО".</div></div></div>',scope:!0,link:function(d,e){d.is_show_lead=!1,d.policy_accept=!0,d.show_policy_rules=!1,d.policy_accept_notify=!1,d.birth_date_obj=[],d.form_submitted=!1,d.set_birth_date=function(){3==d.birth_date_obj.length?d.form.birthDate=d.birth_date_obj.join("-"):d.form.birthDate=""};var h={firstName:"",lastName:"",middleName:"",phone:"",birthDate:""};d.form=angular.copy(h),d.tags=["",""],d.data=angular.copy(a),d.show_lead=function(){d.is_show_lead=!0},d.hide_lead=function(a){a&&a.target==e[0]?(d.is_show_lead=!1,d.form_submitted=!1):a||(d.is_show_lead=!1,d.form_submitted=!1)},c.show_mno_lead=function(){d.$apply(function(){d.show_lead()})},d.submit_lead=function(){if(d.policy_accept_notify){var a=angular.copy(d.tags).concat(g.additional_tags);b.submit_lead(d.form,function(c){"ok"==c.status&&b.add_tags({phone:d.form.phone},a,function(a){d.policy_accept_notify=!1,d.show_policy_rules=!1,d.form=angular.copy(h),d.tags=["",""],d.birth_date_obj=[],d.form_submitted=!0})})}else d.policy_accept_notify=!0,d.show_policy_rules=!0},d.dates=f.dates,d.get_clinics=function(a){var b=!1;for(var c in d.data.cities)d.data.cities[c].name==a&&(b=d.data.cities[c]);return b.clinics},d.is_valid=function(){var a=!0;for(var b in d.form)d.form[b]==h[b]&&(a=!1,d.errors[b]=!0);for(var c in d.tags)d.tags[c]&&""!=d.tags[c]||(a=!1);return a},d.errors={}}}}]).service("sailplay",["$http","config",function(a,b){var c=this;c.submit_lead=function(c,d){a.jsonp((b.domain||"http://sailplay.ru")+"/js-api/"+b.partner_id+"/users/update/?callback=JSON_CALLBACK",{params:c}).success(function(a){d&&d(a)})},c.add_tags=function(c,d,e){var f=angular.copy(c);f.tags=d.join(","),a.jsonp((b.domain||"http://sailplay.ru")+"/js-api/"+b.partner_id+"/tags/add/?callback=JSON_CALLBACK",{params:f}).success(function(a){e&&e(a)})}}]).service("dates",function(){function a(a,b){for(var c=[],d=a;d<=b;d++)c.push(d);return c}this.dates={days:function(){return a(1,31)},months:function(){return{1:"Января",2:"Февраля",3:"Марта",4:"Апреля",5:"Мая",6:"Июня",7:"Июля",8:"Августа",9:"Сентября",10:"Октября",11:"Ноября",12:"Декабря"}},years:function(){var b=(new Date).getFullYear();return a(b-100,b).reverse()}}}),a.addEventListener("load",function(){var a=b.getElementsByTagName("body")[0];if(a){var c=b.createElement("visavis-mno");a.appendChild(c),angular.bootstrap(c,["mno.lead"])}}),c}(window,document);