...
//        cookies.eraseCookie('sp_auth_hash');
  ...
  // GIFTS ARCHIVE
  sp.on('load.gifts.archive', function (params) {
    ...
    JSONP.get(_config.DOMAIN + _config.urls.gifts.purchase.list, params, function (res) {
      if (res.status == 'ok') {
        sp.send('load.gifts.archive.success', res);
      } else {
        sp.send('load.gifts.archive.error', res);
      }
    });
  ...
  // user update
  sp.on('user.update', function (params, callback) {
