...
(function () {
  ...
  angular.module('ltp', ['core', 'ui', 'sp', 'templates'])
    ...
    .directive('sailplayLtp', ["$rootScope", "$locale", function ($rootScope, $locale) {
