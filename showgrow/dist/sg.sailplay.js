...
(function () {
  ...
  angular.module('sg.directives.profile', [])
    ...
    .directive('profileD', ["api", "sp", "userS", "badgeS", "$window", function (api, sp, userS, badgeS, $window) {
      return {
        restrict: 'E',
        replace: false,
