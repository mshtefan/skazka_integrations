...
class Person extends Ctrl {
    constructor(app){
        ...
        this._ModelBase = this._ModelPerson;

        this._ModelPerson.on(ModelPerson.EVENT_LOGGED, ()=>{this.emit(Person.EVENT_API_LOGGED);});
        this._ModelPerson.on(ModelPerson.EVENT_FETCH, ()=>{
            this.emit(Person.EVENT_FETCH);
        });
    ...
    getPurchasesValue () {
        return this._ModelPerson.get('purchasesValue');
    }

    getPoints () {
        return this._ModelPerson.get('pointsValue');
    }
    ...
    getPurchasesCost() {
        return this._ModelPerson.getPurchasesCost();
    }
}
