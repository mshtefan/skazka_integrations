...
class ViewEditForm extends ViewBase {
    ...
    _prepareTplData() {
        ...
        this._tplData['month'] = date[1] ? date[1]*1 : 1;
        this._tplData['monthText'] = date[1] ? months[date[1]*1-1].text : translate['month'];
    ...
    _getFieldsValue () {
        var t = {
            ...
            middleName: this.getEl().querySelector('[name=middle_name]').value,
            ...
            sex: this.getEl().querySelector('[name=pol]:checked').value
        };
