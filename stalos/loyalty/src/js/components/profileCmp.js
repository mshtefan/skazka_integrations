    ...
    .directive('profileCmp', ['userService', 'statusService', function (userService, statusService) {
      return {
        ...
        link: function (scope) {
          ...
          scope.allStatusLink = window.config.status_link || null;
