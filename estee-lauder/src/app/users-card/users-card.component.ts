        ...
        <div class="popup" *ngIf="showApproveDialog">
            ...
            <div class="popup-content">
                ...
                <div class="popup-controls">
                    ...
                    <a href="#" class="button button_black" (click)="$event.preventDefault();onApprove.emit({user: user, occupation: occupationModel});showApproveDialog=false;lockPage(false)">Принять</a>
                </div>
