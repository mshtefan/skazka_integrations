...
export default angular.module('sorcery.services.api', [])
    ...
    .service('apiService', function (spService, $q, $http) {
      ...
      self.login = function (auth_hash) {
        return $q(function (resolve, reject) {
          sp.on('login.success', function (res) {
            resolve(res)
          })
